...
<head>
	...
	<title>Website designer Julia Vlasova</title>
...
<?php
        ...
        if(!$captcha){
          echo '<h2>Please, check your captcha</h2><br><a href="en.php" id="s">Back to the site</a>';
          exit;
        }
        ...
        if(intval($responseKeys["success"]) !== 1) {
          echo '<h2 class="form_answer">Sorry, message failed to be sent</h2>';
        } else {
          echo '<h2 class="form_answer">Thank you for your message!</h2>';
        }
...
?>
    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="nav navbar-nav navbar-right ">	
        <li data-toggle="collapse" data-target=".navbar-collapse.in"><a href="en.php" id="s">Back to the site</a></li>		
      </ul>    
    </div>
</nav>
	</div>
